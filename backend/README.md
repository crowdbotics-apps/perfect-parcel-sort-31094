...
## Project Structure
    ...
    ├── perfect_parcel_sort_31094  # Django project configurations
...
1. Clone this repo and `cd perfect_parcel_sort_31094`
...
2. Clone this repo and `cd perfect_parcel_sort_31094`
